...
const UploadWithDrag = ({setFile, file, geoJSON}) => {
  ...
  const onDrop = useCallback((files) => {
    ...
    const file = files[0]
    if(!(file.type === "application/zip" || file.type === "application/x-zip-compressed")) return dispatch(showAlert("Fayllar faqat .zip formatida bo'lishi lozim"))
  ...
  return (
    <div className="upload-with-comment Upload">
        <div {...getRootProps()} className="dropzone" ref={inputRef} style={{ height: 164 }}>
          <input {...getInputProps()} />
          {!loader ? (
            <>
        ...
        {/* <div className="flex items-center"> */}
          ...
          {/* <a
            ...
            target="_blank"
            rel="noreferrer"
            href={`https://cdn.e-space.javelin.uz/e-space/${file}`}
          >
            <Button
              // loading={loader}
              color="primary"
