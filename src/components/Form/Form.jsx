...
export default function Form ({ initialValues = {}, onSubmit, children, formRef, initialSchema={} }) {
  let schema = initialSchema, values = {}
  ...
  useEffect(() => {
    console.log(validationSchema, _initialValues)
  }, [validationSchema, _initialValues])
  // **** FUNCTIONS ****
  ...
  function setPropsToChild (el, formik) {
    if(el.type.name === "FormItem") {
      ...
      return {...el, props: {...el.props, children: setFormikToChildren(el.props.children, formik)}}
    }
  }
