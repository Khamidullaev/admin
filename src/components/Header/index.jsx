  ...
  return (
    <div className={`w-full bg-white flex justify-between ${className}`}>
      <div className="p-4 flex items-center divide-x">
        {title && title.length ? (
          <div
            className="text-2xl leading-6 font-semibold pr-4"
      ...
      {/* <div className="bg-white h-16 w-full flex items-center font-body border-b-2">
                <div className="flex justify-between w-full items-center px-4">
                    <div className="flex divide-x items-center">
                        <div className="text-lg font-semibold pl-1 pr-4" style={{ color: 'rgba(91, 104, 113, 1)'}}>Заказы</div>
                        <div className=""><Button shape="text" color="text-gray-500" icon={tableIconMini}>Таблица</Button></div>
                        <div className=""><Button shape="text" color="text-gray-500" icon={MapIcon}>Карта</Button></div>
                    </div>
                    <div className="flex divide-x">
                    <Button shape="text" color="text-blue-500" icon={editIcon}>Действия</Button>
                    <Button shape="text" color="text-green-500" icon={plusIcon}>Создать</Button>
                    </div>
                </div>
            </div>
            <div className="bg-gray-50 h-14 w-full flex items-center font-body">
                <div className="flex justify-between w-full items-center px-4">
                    <div className="flex w-4/12">
                        <div className="text-md font-semibold w-4/5"><Input 
                            icon={searchIcon}
                            placeholder="Ид. Заказа, Номер, Курьер, Статус, Способ оплаты"></Input></div>
                        <div className=""></div>
                    </div>
                    <div className="flex space-x-1 w-6/12 justify-end">
                        <Button shape="text" color="text-gray-500" icon={tableIcon}>Столбцы</Button>
                        <Dropdown><Button shape="text" color="text-gray-500" icon={filterIcon}>Фильтр</Button></Dropdown>
                        <Button shape="text" color="text-gray-500" icon={downloadIcon}>Скачать</Button>
                    </div>
                </div>
            </div> */}
    </div>
