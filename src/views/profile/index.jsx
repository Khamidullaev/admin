        ...
        >
          <div>
                  ...
                  {passwordFieldDisabled ? (
                    ...
                    <>
                      ...
                      <div className="w-full flex mb-4">
                        <div className="label">{t("old.password")}</div>
                        <div className="field">
                          <Input
                            type="password"
                            value={oldPassword}
                      ...
                      <div className="w-full flex mb-4">
                        <div className="label">{t("new.password")}</div>
                        <div className="field">
                          <Input
                            type="password"
                            value={newPassword}
            ...
            <div style={{ width: "720px" }}>
              <Card title="Xizmat ma'lumotlari">
                {/* -------------------ORGANIZATION----------------- */}
                ...
                {/* -------------------CITY----------------- */}
                <div className="w-full flex items-baseline">
                  <div className="w-1/3">{t("region.area")}</div>
                  <div className="w-2/3">
                    <FormItem>
              ...
              <Card title="Shaxsiy ma'lumotlar" className="mt-5">
                {/* ---------FIRST_NAME--------- */}
                <div>
                  <div className="w-full flex items-baseline">
                    <div className="w-1/3">
