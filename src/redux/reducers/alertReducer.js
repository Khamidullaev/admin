import { ADD_NEW_ALERT, DELETE_ALERT, SET_GLOBAL_ALERT, SET_GLOBAL_ALERT_HEIGHT } from "../constants"
...
export const setGlobalAlert = (alert) => ({ type: SET_GLOBAL_ALERT, payload: alert })
export const setGlobalAlertHeight = (height) => ({ type: SET_GLOBAL_ALERT_HEIGHT, payload: height })
